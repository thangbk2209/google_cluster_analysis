...
file_names = ['resource_usage_3Minutes_6176858948.csv','resource_usage_7Minutes_6176858948.csv','resource_usage_10Minutes_6176858948.csv']
file_results = ['3Minutes_6176858948_notNan.csv','7Minutes_6176858948_notNan.csv','10Minutes_6176858948_notNan.csv']
for i in range(3):
