...
data = sql_context.sql("SELECT startTime/1000000,meanCPUUsage from dataFrame")
...
data.toPandas().to_csv('thangbk2209/plotTimeSeries/CPUUsageTimeSeries.csv', index=False, header=None)
