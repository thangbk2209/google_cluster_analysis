...
folder_paths = ['thangbk2209/10minutes_6176858948/']
folder_results = ['resource_10Minutes_6176858948']
for i in range(1):
    ...
    for file_name in os.listdir(folder_path):
        ...
        reSourceDf.toPandas().to_csv('thangbk2209/%s/%s'%(folder_result,file_name), index=False, header=None)
    sc.stop()