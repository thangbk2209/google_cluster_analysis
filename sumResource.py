...
folder_path = '/mnt/volume/ggcluster/spark-2.1.1-bin-hadoop2.7/thangbk2209/twoMinutes_6176858948/'
...
for file_name in os.listdir(folder_path):
    ...
    reSourceDf.toPandas().to_csv('thangbk2209/resource_twoMinutes_6176858948/%s'%(file_name), index=False, header=None)
sc.stop()